...
{
    AllOff();
    int SensorStatus = analogRead(A6);
    if(SensorStatus>=0 && SensorStatus<=51)
    {
        Flicker();
    }
    else if(SensorStatus>51 && SensorStatus<=55)
    {
        LayerONOFF();
    }
    else if(SensorStatus>55 && SensorStatus<=58)
    {
        SpiralInAndOut();
    }
    else if(SensorStatus>58 && SensorStatus<=61)
    {
        ErraticLED();
    }
    else if(SensorStatus>58 && SensorStatus<=61)
